...
//   useEffect(() => {
//     axios.get('http://localhost:5000/api/employees').then(r=>setEmps(r.data));
//   }, [refresh]);
...
//   return (
//     <Box p={4}>
//       <Typography variant="h5" fontWeight="bold" mb={2}>Manage Employee</Typography>

//       <Grid container justifyContent="flex-end" mb={2}>
//         <TextField size="small" label="Search Record" value={search} onChange={e=>{setSearch(e.target.value); setPage(1);}}/>
//       </Grid>

//       <Table>
//         <TableHead sx={{ background:'#f5f5f5' }}>
//           <TableRow>
//             {['S.No','Emp ID','Name','Department','Status','Reg Date','Action'].map(h=><TableCell key={h}>{h}</TableCell>)}
//           </TableRow>
//         </TableHead>
//         <TableBody>
//           {slice.map((e,index)=>
...
//               <TableCell>
//                 <IconButton sx={{ bgcolor:'green', color:'#fff', mr:1, '&:hover':{bgcolor:'green'} }}><EditIcon /></IconButton>
//                 <IconButton sx={{ bgcolor:'red', color:'#fff','&:hover':{bgcolor:'red'} }} onClick={()=>del(e.id)}><DeleteIcon /></IconButton>
//               </TableCell>
//             </TableRow>
//           )}
//         </TableBody>
...
//         <Typography variant="body2">Showing {(page-1)*rows+1} to {Math.min(page*rows, filtered.length)} of {filtered.length} entries</Typography>
//         <Pagination count={pageCount || 1} page={page} onChange={(_,v)=>setPage(v)} color="primary"/>
//       </Grid>
